...
import {
    ...
    Point,
    ProjectivePoint
} from "crysol/secp256k1/Secp256k1.sol";
...
contract ERC5564Example is Script {
    ...
    using StealthAddresses for SecretKey;
    using StealthAddresses for StealthMetaAddress;

    function run() public {
        // Alice creates a key pair funded with 1 ETH.
        SecretKey aliceSk = Secp256k1Offchain.newSecretKey();
        ...
        SecretKey bobSpendSk = Secp256k1Offchain.newSecretKey();
        PublicKey memory bobSpendPk = bobSpendSk.toPublicKey();
        SecretKey bobViewSk = Secp256k1Offchain.newSecretKey();
